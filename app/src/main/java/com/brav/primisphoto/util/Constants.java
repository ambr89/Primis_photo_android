...
public class Constants {
    ...
    public static String URIs_photo = "URIs";

    public static final String PREFS_INTERNAL_DATA = "MyPrefsFile";

    public static final String INTERNAL_IMAGE_FOlDER = "imageDir";

    public static final String EXTRA_IMAGE_URI = "imageUri";

    public static String USERNAME = "USERNAME";
    public static String PASSWORD = "PASSWORD";
    public static String N_SCHEDA = "N_SCHEDA";
    public static String N_MAXLENNOTE = "N_MAXLENNOTE";

    public static String PREFIX_PRIMIS_RED = "S";
    public static String PREFIX_PRIMIS_GREEN = "R";
